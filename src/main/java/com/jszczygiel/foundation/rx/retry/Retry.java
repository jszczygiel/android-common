...
public class Retry {
     ...
     * @return an Observable that combines the index/attempt number of each error with its error in a {@link Tuple}.
     */
    protected static Observable<Tuple<Integer, Throwable>> errorsWithAttempts(Observable<? extends Throwable> errors,
