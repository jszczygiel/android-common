...
public abstract class Delay {
  ...
  /**
   * Creates a new {@link ExponentialDelay} with default boundaries and factor (1, 2, 4, 8, 16,
   * 32...).
   *
   * @param unit the unit of the delay.
  ...
  /**
   * Creates a new {@link ExponentialDelay} on a base different from powers of two, with custom
