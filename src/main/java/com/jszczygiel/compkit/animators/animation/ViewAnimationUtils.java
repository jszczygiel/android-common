...
public final class ViewAnimationUtils {
  ...
  private static final boolean LOLLIPOP_PLUS = SDK_INT >= LOLLIPOP;

  /**
   * Returns an Animator which can animate a clipping circle.
   *
   * <p>Any shadow cast by the View will respect the circular clip from this animator.
   *
   * <p>Only a single non-rectangular clip can be applied on a View at any time. Views clipped by a
   * circular reveal animation take priority over {@link View#setClipToOutline(boolean) View Outline
   * clipping}.
   *
   * <p>Note that the animation returned here is a one-shot animation. It cannot be re-used, and
   * once started it cannot be paused or resumed.
   *
  ...
  public static Animator createCircularReveal(
    ...
    return createCircularReveal(
        view, centerX, centerY, startRadius, endRadius, View.LAYER_TYPE_SOFTWARE);
  }
  ...
  public static Animator createCircularReveal(
    ...
    ViewRevealManager.RevealValues viewData =
        new ViewRevealManager.RevealValues(view, centerX, centerY, startRadius, endRadius);
