...
public class ViewRevealManager {
  ...
  /**
   * Property animator. For performance improvements better to use directly variable member (but
   * it's little enhancement that always caught as dangerous, let's see)
   */
